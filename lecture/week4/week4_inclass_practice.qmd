...
pa_counties <- st_read(here("C:/Users/Gab/OneDrive/Documents/SPRING 2026/CPLN5920_PPA/PPA_Portfolio/lecture/week4/Pennsylvania_County_Boundaries/Pennsylvania_County_Boundaries.shp"))
districts <- st_read(here("C:/Users/Gab/OneDrive/Documents/SPRING 2026/CPLN5920_PPA/PPA_Portfolio/lecture/week4/districts.geojson"))
hospitals <- st_read(here("C:/Users/Gab/OneDrive/Documents/SPRING 2026/CPLN5920_PPA/PPA_Portfolio/lecture/week4/hospitals.geojson"))
...
st_touches excludes your selected county while st_intersects include your selected county.
---
...
```{r}
# get elderly and income data from ACS for PA census tracts
# define elderly vars
elderly_vars <- c(
  totpop = "B01003_001",
...
# Add two new columns elderly_total and pct_elderly to the data set
pa_demographic <- pa_demographic %>%
  ...
  mutate(
    pct_elderly = round(elderly_total / totpopE * 100, 1)
  )

# Define low-income and high elderly thresholds
income_cutoff <- quantile(pa_demographic$medincE, 0.25, na.rm = TRUE)
elderly_cutoff <- quantile(pa_demographic$pct_elderly, 0.75, na.rm = TRUE)

# Flag low-income and high elderly tracts
vulnerable_tracts <- pa_demographic %>%
  mutate(
    low_income = medincE <= income_cutoff,
    high_elderly = pct_elderly >= elderly_cutoff,
