...
# Read GeoJSON
districts <- st_read("C:/Users/Gab/OneDrive/Documents/SPRING 2026/CPLN5920_PPA/PPA_Portfolio/lecture/week4/districts.geojson")
...
hospitals <- hospitals %>%
  st_transform(st_crs(pa_counties)) # put hospitals in the same coordinate system as the pa_counties
