...
ri <- get_acs(geography = "county", variables = c(totpop = "B01003_001", medinc = "B19013_001"),
...
**Your Task:** Identify the 3 counties with the highest MOE percentages.

**Requirements:**
- Sort by MOE percentage (highest first)
- Select the top 3 counties
...
kable(col.names = c(
  ...
  caption = "Top 3 Rhode Island Counties with Highest Income Estimate Uncertainty"
)
