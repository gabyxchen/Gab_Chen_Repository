...
**Comment on the output:** [Using filter() to select a certain number of observations requires you to have a basic understangding of your dataframe.]
...
pa_data <- pa_data %>%
  mutate(
    pct_white = (whiteE / totpopE) * 100,
    pct_black = (blackE / totpopE) * 100,
    pct_his_lat = (his_latE / totpopE) * 100
  )

# Add readable tract and county name columns using str_extract() or similar
pa_data <- pa_data %>%
  mutate(name_clean, str_extract(NAME, "^Census Tract" ))
```
